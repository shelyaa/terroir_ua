      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-6xl mx-auto">
        {winemakers.map((w) => (
          <Link to={w.link} key={w.name}>
            <div className="cursor-pointer w-full max-w-[500px] h-130 max-h-150 mx-auto flex flex-col gap-4 items-center border border-[#9F9F9F] p-4 hover:shadow-md transition">
              <img
                src={w.image}
                alt={w.name}
...
const winemakers = [
  {
    ...
    image: "/photos/46_Parallel_Wine_Group.png",
    description:
  ...
  },
  {
    ...
    image: "photos/Don_Alejandro_Winery.png",
    description:
  ...
  },
  {
    ...
    image: "/photos/Beykush_Winery.png",
    description:
